                ...
                <article>
                    ...
                    @if (Auth::user())
                        ...
                        <div class="mb-5 d-flex gap-3">
                            {{-- like button  --}}
                            <div class="">
                                <a href="{{ route('post.like', [$post->id, Auth::user()->id]) }}"
                    ...
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <form action="" class="mb-4">
                                <textarea name="" class="form-control" id="" rows="3" style="resize: none"></textarea>
                            </form>
                            {{-- Comment with nested comment  --}}
                            <div class="d-flex mb-4">
                                {{-- Parent Comment  --}}
                                <div class="flex-shrink-0">
                                    <img src="https://dummyimage.com/50x50/ced4da/6c757d.jpg" alt=""
